...
public:
    ...
    private:
        ...
        double zmp_err_int;
        double u_prev;
        double Ref_Xpos[12] = { 0 }; //수정
    public:
        void Change_Ref_Xpos(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j, double k, double l);//수정
        X_Com();
    ...
    private:
        ...
        double zmp_err_int;
        double u_prev;
        double Ref_Ypos[12] = { 0 }; //수정
    public:
        Y_Com();
        void Change_Ref_Ypos(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j, double k, double l);//수정
    ...
    private:
        ...
        double step;
        double freq;
        Matrix<double, 6, 1> XStep;//수정
        Matrix<double, 6, 1> XStride;//수정
    public:
        Foot();
